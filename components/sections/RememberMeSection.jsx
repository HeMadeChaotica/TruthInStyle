...
const MONTH_LAYOUT_CONFIG = {
  0: { key: 'january', calendarRight: 'clamp(56px, 5vw, 96px)', calendarBottom: 'clamp(56px, 6vh, 96px)', calendarWidth: 'clamp(380px, 35vw, 560px)', calendarScale: 0.92 },
  1: { key: 'february', calendarRight: 'clamp(56px, 5vw, 96px)', calendarBottom: 'clamp(56px, 6vh, 96px)', calendarWidth: 'clamp(370px, 34vw, 540px)', calendarScale: 0.91 },
  2: { key: 'march', calendarRight: 'clamp(56px, 5vw, 96px)', calendarBottom: 'clamp(56px, 6vh, 96px)', calendarWidth: 'clamp(380px, 35vw, 560px)', calendarScale: 0.92 },
  3: { key: 'april', calendarRight: 'clamp(56px, 5vw, 96px)', calendarBottom: 'clamp(56px, 6vh, 96px)', calendarWidth: 'clamp(370px, 34vw, 540px)', calendarScale: 0.91 },
  4: { key: 'may', calendarRight: 'clamp(64px, 5.4vw, 104px)', calendarBottom: 'clamp(60px, 6.4vh, 104px)', calendarWidth: 'clamp(390px, 36vw, 570px)', calendarScale: 0.92 },
  5: { key: 'june', calendarRight: 'clamp(64px, 5.4vw, 104px)', calendarBottom: 'clamp(60px, 6.4vh, 104px)', calendarWidth: 'clamp(390px, 36vw, 570px)', calendarScale: 0.92 },
  6: { key: 'july', calendarRight: 'clamp(56px, 5vw, 96px)', calendarBottom: 'clamp(56px, 6vh, 96px)', calendarWidth: 'clamp(380px, 35vw, 560px)', calendarScale: 0.92 },
  7: { key: 'august', calendarRight: 'clamp(56px, 5vw, 96px)', calendarBottom: 'clamp(56px, 6vh, 96px)', calendarWidth: 'clamp(370px, 34vw, 540px)', calendarScale: 0.91 },
  8: { key: 'september', calendarRight: 'clamp(56px, 5vw, 96px)', calendarBottom: 'clamp(56px, 6vh, 96px)', calendarWidth: 'clamp(370px, 34vw, 540px)', calendarScale: 0.91 },
  9: { key: 'october', calendarRight: 'clamp(60px, 5.2vw, 100px)', calendarBottom: 'clamp(58px, 6.2vh, 100px)', calendarWidth: 'clamp(375px, 34.5vw, 550px)', calendarScale: 0.91 },
  10: { key: 'november', calendarRight: 'clamp(56px, 5vw, 96px)', calendarBottom: 'clamp(56px, 6vh, 96px)', calendarWidth: 'clamp(380px, 35vw, 560px)', calendarScale: 0.92 },
  11: { key: 'december', calendarRight: 'clamp(56px, 5vw, 96px)', calendarBottom: 'clamp(56px, 6vh, 96px)', calendarWidth: 'clamp(380px, 35vw, 560px)', calendarScale: 0.92 }
};
