...
const MONTH_LAYOUT_CONFIG = {
  0: { key: 'january', assetMode: 'standard', calendarLeft: '50.5%', calendarTop: '13%', calendarWidth: '44%', calendarMaxWidth: '680px', calendarScale: 0.92, postcardsLeft: '50.5%', postcardsTop: '73%', postcardsWidth: '44%', postcardsMinHeight: '64px', popoutLeft: '43%', popoutTop: '12%', popoutWidth: '50%', artSafeRight: '47%' },
  1: { key: 'february', assetMode: 'standard', calendarLeft: '55%', calendarTop: '23%', calendarWidth: '39%', calendarMaxWidth: '610px', calendarScale: 0.88, postcardsLeft: '55%', postcardsTop: '76%', postcardsWidth: '39%', postcardsMinHeight: '60px', popoutLeft: '42%', popoutTop: '13%', popoutWidth: '51%', artSafeRight: '53%' },
  2: { key: 'march', assetMode: 'standard', calendarLeft: '55%', calendarTop: '17%', calendarWidth: '40%', calendarMaxWidth: '620px', calendarScale: 0.88, postcardsLeft: '55%', postcardsTop: '74%', postcardsWidth: '40%', postcardsMinHeight: '60px', popoutLeft: '42%', popoutTop: '12%', popoutWidth: '51%', artSafeRight: '53%' },
  3: { key: 'april', assetMode: 'standard', calendarLeft: '55%', calendarTop: '20%', calendarWidth: '40%', calendarMaxWidth: '620px', calendarScale: 0.89, postcardsLeft: '55%', postcardsTop: '75%', postcardsWidth: '40%', postcardsMinHeight: '60px', popoutLeft: '42%', popoutTop: '12%', popoutWidth: '51%', artSafeRight: '53%' },
  4: { key: 'may', assetMode: 'standard', calendarLeft: '48.5%', calendarTop: '12%', calendarWidth: '47%', calendarMaxWidth: '720px', calendarScale: 0.94, postcardsLeft: '48.5%', postcardsTop: '75%', postcardsWidth: '47%', postcardsMinHeight: '64px', popoutLeft: '39%', popoutTop: '12%', popoutWidth: '54%', artSafeRight: '46%' },
  5: { key: 'june', assetMode: 'standard', calendarLeft: '48%', calendarTop: '13%', calendarWidth: '47%', calendarMaxWidth: '720px', calendarScale: 0.94, postcardsLeft: '48%', postcardsTop: '75%', postcardsWidth: '47%', postcardsMinHeight: '64px', popoutLeft: '39%', popoutTop: '12%', popoutWidth: '54%', artSafeRight: '46%' },
  6: { key: 'july', assetMode: 'standard', calendarLeft: '49%', calendarTop: '12%', calendarWidth: '46%', calendarMaxWidth: '700px', calendarScale: 0.93, postcardsLeft: '49%', postcardsTop: '74%', postcardsWidth: '46%', postcardsMinHeight: '64px', popoutLeft: '40%', popoutTop: '12%', popoutWidth: '53%', artSafeRight: '47%' },
  7: { key: 'august', assetMode: 'standard', calendarLeft: '54%', calendarTop: '24%', calendarWidth: '41%', calendarMaxWidth: '640px', calendarScale: 0.89, postcardsLeft: '54%', postcardsTop: '77%', postcardsWidth: '41%', postcardsMinHeight: '60px', popoutLeft: '42%', popoutTop: '13%', popoutWidth: '52%', artSafeRight: '52%' },
  8: { key: 'september', assetMode: 'standard', calendarLeft: '54%', calendarTop: '22%', calendarWidth: '41%', calendarMaxWidth: '640px', calendarScale: 0.89, postcardsLeft: '54%', postcardsTop: '76%', postcardsWidth: '41%', postcardsMinHeight: '60px', popoutLeft: '42%', popoutTop: '13%', popoutWidth: '52%', artSafeRight: '52%' },
  9: { key: 'october', assetMode: 'standard', calendarLeft: '51%', calendarTop: '20%', calendarWidth: '44%', calendarMaxWidth: '680px', calendarScale: 0.91, postcardsLeft: '51%', postcardsTop: '76%', postcardsWidth: '44%', postcardsMinHeight: '60px', popoutLeft: '40%', popoutTop: '13%', popoutWidth: '53%', artSafeRight: '49%' },
  10: { key: 'november', assetMode: 'panoramic', calendarLeft: '47%', calendarTop: '15%', calendarWidth: '47%', calendarMaxWidth: '720px', calendarScale: 0.91, postcardsLeft: '47%', postcardsTop: '73%', postcardsWidth: '47%', postcardsMinHeight: '60px', popoutLeft: '39%', popoutTop: '11%', popoutWidth: '54%', artSafeRight: '45%' },
  11: { key: 'december', assetMode: 'panoramic', calendarLeft: '57%', calendarTop: '18%', calendarWidth: '38%', calendarMaxWidth: '610px', calendarScale: 0.86, postcardsLeft: '57%', postcardsTop: '74%', postcardsWidth: '38%', postcardsMinHeight: '60px', popoutLeft: '42%', popoutTop: '11%', popoutWidth: '52%', artSafeRight: '55%' }
};
...
export default function RememberMeSection() {
  ...
  const monthVisual = monthLayout.assetMode === 'panoramic' ? { backgroundPosition: 'top center', backgroundSize: '100% auto' } : { backgroundPosition: 'left 28% center', backgroundSize: 'contain' };
