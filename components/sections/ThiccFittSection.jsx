  ...
  return (
    <section className="tf-page">
      ...
      <main className="tf-grid">
        ...
        <section className="tf-panel tf-notes"><h2>3. NOTES + SO HOW YOU DOIN 🫦⁉️</h2><div className="tf-row"><select value={form.notesPrompt} onChange={(e)=>updateField('notesPrompt', e.target.value)}><option value="">SELECT PROMPT</option><option>How was performance?</option><option>Energy level?</option></select><textarea value={form.notesText} onChange={(e)=>updateField('notesText', e.target.value)} placeholder="WRITE YOUR THOUGHTS HERE..." /></div></section>
