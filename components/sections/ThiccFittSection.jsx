...
export default function ThiccFittSection() {
  ...
  useEffect(() => {
    try {
      ...
      setState((p) => ({ ...p, ...parsed, exerciseRows: normalizeExerciseRows(parsed.exerciseRows) }));
    } catch {
      // keep default state
    }
  }, []);
