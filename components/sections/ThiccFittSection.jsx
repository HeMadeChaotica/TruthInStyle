...
export default function ThiccFittSection() {
  ...
  const shelves = [
    ...
    { id: 'E', columns: 1, panels: [{ id: 'recovery-notes', token: 'compact', content: <><h2>RECOVERY NOTES</h2><textarea className="tf30-lined-notes tf30-recovery-notes" value={state.weeklyTrackers.byDay[todayDay].sleep.recoveryNotes} onChange={(e) => updateSleepDay(todayDay, 'recoveryNotes', e.target.value)} /></> }] },
