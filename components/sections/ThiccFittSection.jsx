...
export default function ThiccFittSection() {
  ...
  const [dailyQuote, setDailyQuote] = useState(optionRegistry.thiccFitt.quoteOfDay[0] || null);
  ...
  return <SectionShell className="tf30-shell thicc-fitt-page"><ScenePlate><div className="tf30-bg" /><div className="tf30-overlay" /></ScenePlate><SectionOverlay><ArtLane className="tf30-left"><Link href="/its-getting-thicc" className="tf30-crystal" aria-label="Crystal dumbbell access"><img src="/control-panel/control-thicc-fitt.png" alt="Crystal dumbbell" draggable={false} /></Link></ArtLane><ContentScroller><BlueprintStack shelves={shelves} /></ContentScroller></SectionOverlay></SectionShell>;
}
