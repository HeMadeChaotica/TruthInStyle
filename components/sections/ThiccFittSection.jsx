...
export default function ThiccFittSection() {
  ...
  const shelves = [
    ...
    { id: 'G', columns: 1, panels: [{ id: 'proof-wall', token: 'compact', content: <><h2>THE TROPHY WALL</h2><label className="tf30-featured-photo">{state.photo.featuredPhoto ? <img src={state.photo.featuredPhoto} alt="ITS GIVIN THICC session" /> : 'FEATURED SESSION PHOTO'}<input className="tf30-file-input" type="file" accept="image/*" onChange={uploadFeaturedPhoto} /></label></> }] },
