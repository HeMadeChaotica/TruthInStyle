...
export default function ItsGettingThiccSection() {
  ...
  const viewedMonthDate = useMemo(() => new Date(`${selectedTimeDate}T12:00:00`), [selectedTimeDate]);
