...
import { getDaEaterStorageDate } from './daEaterDateKey';
...
export function readDaEaterMacroMirror(date = getDaEaterStorageDate()) {
    ...
    return {
      ...
      rows: DA_EATER_MACRO_CONFIG.map((item) => {
        ...
        return {
          ...
          currentDisplay: formatAmount(current, item.unit),
