...
export const CLOCK_IT_REGISTRY = Object.freeze({
  ...
  [CLOCK_IT_KEYS.rememberEventTypes]: list('REMEMBER.ME', 'EVENT TYPES', ['SOMETHING NEW DAY','TREAT DAY','REMINDER','JOB INTERVIEW','BIRTHDAY','ANNIVERSARY','MEETING','DEADLINE','EVENT (WORK)','PAYDAY','TRAVEL','CALL','DICK APPOINTMENT','SOCIAL NETWORKING','DATE','HEALTH','RENT','PACKAGE DELIVERY','HAIRCUT']),
